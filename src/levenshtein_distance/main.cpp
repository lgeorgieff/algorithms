...
int main() {
  levenshtein_distance distance1("executions", "intention");
  ...
  levenshtein_distance distance2("executions", "intention", config2);
  ...
  levenshtein_distance distance3("executions", "intention", config3);
  ...
  levenshtein_distance distance4("executions", "intention", config4);
  ...
  levenshtein_distance distance5("executions", "intention", config5);
  ...
  levenshtein_distance distance6("executions", "intention", config6);
